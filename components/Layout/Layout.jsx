        ...
        <section className="section">
          <div className="section-header">
            ...
            <div className="section-header-breadcrumb">
              ...
              <div className="breadcrumb-item"><a href="#">Components</a></div>
          ...
          <div className="section-body">
            ...
            <div className="row">
              <div className="col-12 col-sm-6 col-md-6 col-lg-3">
                <article className="article">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img08.jpg">
                    </div>
              ...
              <div className="col-12 col-sm-6 col-md-6 col-lg-3">
                <article className="article">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img04.jpg">
                    </div>
                    <div className="article-title">
                      <h2><a href="#">Excepteur sint occaecat cupidatat non proident</a></h2>
                    </div>
              ...
              <div className="col-12 col-sm-6 col-md-6 col-lg-3">
                <article className="article">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img09.jpg">
                    </div>
                    <div className="article-title">
                      <h2><a href="#">Excepteur sint occaecat cupidatat non proident</a></h2>
                    </div>
              ...
              <div className="col-12 col-sm-6 col-md-6 col-lg-3">
                <article className="article">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img12.jpg">
                    </div>
                    <div className="article-title">
                      <h2><a href="#">Excepteur sint occaecat cupidatat non proident</a></h2>
                    </div>
            ...
            <div className="row">
              <div className="col-12 col-sm-6 col-md-6 col-lg-3">
                <article className="article article-style-b">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img13.jpg">
                    </div>
                    <div className="article-badge">
                      <div className="article-badge-item bg-danger"><i className="fas fa-fire"></i> Trending</div>
                    </div>
                  </div>
                  <div className="article-details">
                    <div className="article-title">
              ...
              <div className="col-12 col-sm-6 col-md-6 col-lg-3">
                <article className="article article-style-b">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img15.jpg">
                    </div>
                  </div>
                  <div className="article-details">
                    <div className="article-title">
              ...
              <div className="col-12 col-sm-6 col-md-6 col-lg-3">
                <article className="article article-style-b">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img07.jpg">
                    </div>
                  </div>
                  <div className="article-details">
                    <div className="article-title">
              ...
              <div className="col-12 col-sm-6 col-md-6 col-lg-3">
                <article className="article article-style-b">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img02.jpg">
                    </div>
                  </div>
                  <div className="article-details">
                    <div className="article-title">
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-4 col-lg-4">
                <article className="article article-style-c">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img14.jpg">
                    </div>
                  </div>
                  <div className="article-details">
                    <div className="article-category"><a href="#">News</a> <div className="bullet"></div> <a href="#">5 Days</a></div>
                    ...
                    cillum dolore eu fugiat nulla pariatur. </p>
                    <div className="article-user">
                      <img alt="image" src="https://demo.getstisla.com/assets/img/avatar/avatar-3.png"/>
                      <div className="article-user-details">
                        <div className="user-detail-name">
              ...
              <div className="col-12 col-md-4 col-lg-4">
                <article className="article article-style-c">
                  <div className="article-header">
                    <div className="article-image" data-background="https://demo.getstisla.com/assets/img/news/img01.jpg">
                    </div>
                  </div>
                  <div className="article-details">
                    <div className="article-category"><a href="#">News</a> <div className="bullet"></div> <a href="#">5 Days</a></div>
                    ...
                    cillum dolore eu fugiat nulla pariatur. </p>
                    <div className="article-user">
                      <img alt="image" src="https://demo.getstisla.com/assets/img/avatar/avatar-2.png"/>
                      <div className="article-user-details">
                        <div className="user-detail-name">
